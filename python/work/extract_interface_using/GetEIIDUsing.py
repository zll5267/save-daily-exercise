...
def handleNeededEIID(filename, needed_interfaces):
    ...
    start_keys = interface_startwords.keys()
    start_keys = sorted(start_keys)
    for startwords in start_keys:
...
#o.inputfile = "/home/leliang/work/ElastosRDK5/ElastosRDK5_0/Sources/Elastos/Frameworks/Droid/Base/Core/src/elastos/droid/internal/policy/impl/keyguard/KeyguardServiceDelegate.cpp"
        o.inputfile = "/home/leliang/work/ElastosRDK5/ElastosRDK5_0/Sources/Elastos/Frameworks/Droid/Base/Core/src/elastos/droid/internal/policy/impl/keyguard/KeyguardExitDelegate.cpp"
#o.interfacefile = "/home/leliang/myfile/projects/save-daily-exercise/python/work/extract_car_interface/interfaces.txt"
        o.interfacefile = "interfaces.txt"
    ...
    if interfacefile:
        ...
        with open(interfacefile) as finterfaces:
            ...
            g_all_declared_interfaces_dic = {name[name.rfind(':')+1:]: [] for name in g_all_declared_interfaces_list}
            for name in g_all_declared_interfaces_list:
                g_all_declared_interfaces_dic[name[name.rfind(':')+1:]].append(name)
#print(g_all_declared_interfaces_dic["IIStatusBarService"])
    else:
        carfile = o.carfile
